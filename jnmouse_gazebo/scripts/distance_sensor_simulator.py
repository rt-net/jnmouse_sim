...
def listener():
    rospy.Subscriber("{}jnmouse_on_gazebo/rf_scan".format(rospy.get_namespace()), LaserScan, sensor1_callback)
    rospy.Subscriber("{}jnmouse_on_gazebo/rs_scan".format(rospy.get_namespace()), LaserScan, sensor2_callback)
    rospy.Subscriber("{}jnmouse_on_gazebo/ls_scan".format(rospy.get_namespace()), LaserScan, sensor3_callback)
    rospy.Subscriber("{}jnmouse_on_gazebo/lf_scan".format(rospy.get_namespace()), LaserScan, sensor4_callback)
